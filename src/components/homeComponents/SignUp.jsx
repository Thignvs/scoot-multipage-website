...
const SignUp = () => {
    return (
        <div className='bg-DarkNavy py-20 px-5 bg-[url("./src/assets/patterns/semi-circles.svg")] bg-repeat-x bg-[left_-600px_bottom] md:bg-no-repeat md:bg-bottom lg:flex justify-around items-center lg:bg-right-bottom'>
